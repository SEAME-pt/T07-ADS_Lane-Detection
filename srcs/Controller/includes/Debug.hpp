...
public:
    ...
    void showOutputVideo(cv::Mat& output_frame, cv::Mat& output_frame, float left_slope, float left_intercept, float right_slope, float right_intercept, float angle, float offset, int camera_offset = 0);
