...
const double R_DELTA_RATE = 2.0; // Weight for steering rate effort
...
#define F_H 340 // Frame height (updated for 340-line image)
...
// Members for lane geometry historical data
#define MAX_HISTORY_SIZE 10 // Maximum size of the history
#define MISSING_EDGE_HISTORY_SIZE 5 // Size of missing edge history buffers
...
// Constants for lane validation
const double SLOPE_THRESHOLD = 0.1; // Max slope difference between edges
const double POSITION_THRESHOLD = 50.0; // Max pixel shift for edge intercepts
const double MIN_LANE_WIDTH_METERS = 0.24; // Min lane width in meters
const double MAX_LANE_WIDTH_METERS = 0.28; // Max lane width in meters
const size_t LANE_HISTORY_SIZE = 10; // Size of lane candidate history
